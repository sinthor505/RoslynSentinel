...
public class SentinelScanTools
{
        ...
        try
        {
            ...
            switch (detector)
            {
                ...
                case DetectorId.async_void_without_try_catch:
                    ...
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result3 };
                ...
                case DetectorId.cancellation_token_not_forwarded:
                    ...
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result5 };
                case DetectorId.configure_await_missing:
                    ...
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result6 };
                ...
                case DetectorId.unawaited_dispose:
                    ...
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result18 };
                case DetectorId.unobserved_task_in_field:
                    var result19 = await _asyncSafetyEngine.FindUnobservedTaskInFieldAsync(filePath);
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result19 };
                case DetectorId.value_task_misuse:
                    ...
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result20 };
                ...
                case DetectorId.cas_loop_without_backoff:
                    ...
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result21 };
                case DetectorId.check_then_act_on_dictionary:
                    ...
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result22 };
                case DetectorId.concurrent_collection_opportunities:
                    ...
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result23 };
                case DetectorId.double_checked_locking:
                    ...
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result24 };
                case DetectorId.possible_deadlocks:
                    var result25 = await _analysisEngine.FindPossibleDeadlocksAsync(projectName, filePath);
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result25 };
                case DetectorId.semaphore_usage:
                    var result26 = await _analysisEngine.AnalyzeSemaphoreUsageAsync(RequireFile(scope, scopeName));
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result26 };
                case DetectorId.unsafe_lazy_init:
                    ...
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result27 };
                case DetectorId.unsafe_lazy_init_thread:
                    ...
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result28 };
                ...
                case DetectorId.json_anti_patterns:
                    ...
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result29 };
                case DetectorId.package_inconsistency:
                    var result30 = await _dependencyEngine.CheckPackageInconsistencyAsync();
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result30 };
                case DetectorId.project_consistency:
                    var result31 = await _projectConsistencyEngine.CheckConsistencyAsync();
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result31 };
                ...
                case DetectorId.mutable_public_collection_properties:
                    ...
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result32 };
                case DetectorId.mutable_public_properties:
                    ...
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result33 };
                case DetectorId.naming_violations:
                    var result34 = await _antiPatternEngine.FindNamingViolationsAsync(filePath, projectName);
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result34 };
                case DetectorId.readonly_field_candidates:
                    ...
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result35 };
                case DetectorId.string_magic_values:
                    ...
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result36 };
                case DetectorId.todo_fixme_comments:
                    var result37 = await _discoveryEngine.FindTodoFixmeCommentsAsync(filePath, projectName);
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result37 };
                ...
                case DetectorId.all_throw_sites:
                    ...
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result38 };
                case DetectorId.empty_catch_blocks:
                    var result39 = await _analysisEngine.CheckForEmptyCatchBlocksAsync(filePath, projectName);
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result39 };
                case DetectorId.exception_handling:
                    ...
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result40 };
                case DetectorId.memory_leaks:
                    var result41 = await _analysisEngine.DetectMemoryLeaksAsync(RequireFile(scope, scopeName));
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result41 };
                case DetectorId.misbound_overload_chains:
                    var result42 = await _analysisEngine.FindMisboundOverloadChainsAsync(projectName);
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result42 };
                case DetectorId.missing_generic_constraints:
                    ...
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result43 };
                case DetectorId.multiple_out_parameter_methods:
                    ...
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result44 };
                case DetectorId.non_exhaustive_enum_switches:
                    ...
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result45 };
                case DetectorId.possible_infinite_loops:
                    ...
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result46 };
                case DetectorId.redundant_cast:
                    var result47 = await _analysisEngine.CheckForRedundantCastAsync(filePath, projectName);
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result47 };
                case DetectorId.resource_disposal:
                    var result48 = await _analysisEngine.OptimizeResourceDisposalAsync(filePath, projectName);
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result48 };
                case DetectorId.services_not_registered:
                    ...
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result49 };
                case DetectorId.stack_overflow_risks:
                    ...
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result50 };
                case DetectorId.unbounded_recursion:
                    var result51 = await _analysisEngine.FindUnboundedRecursionAsync(projectName);
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result51 };
                case DetectorId.unbounded_static_collections:
                    ...
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result52 };
                case DetectorId.value_type_mutation_intent:
                    ...
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result53 };
                ...
                case DetectorId.obsolete_callers:
                    ...
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result54 };
                case DetectorId.uninstantiated_types:
                    var result55 = await _analysisEngine.FindUninstantiatedTypesAsync(projectName);
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result55 };
                case DetectorId.unused_constructors:
                    ...
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result56 };
                case DetectorId.unused_event_subscriptions:
                    ...
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result57 };
                case DetectorId.unused_interfaces:
                    var result58 = await _analysisEngine.FindUnusedInterfacesAsync(projectName);
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result58 };
                case DetectorId.unused_local_variables:
                    ...
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result59 };
                case DetectorId.unused_private_fields:
                    ...
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result60 };
                ...
                case DetectorId.unvalidated_regex_source:
                    ...
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result79 };

                // ── structure ──────────────────────────────────────────────────────

                case DetectorId.circular_dependencies:
                    var result80 = await _analysisEngine.FindCircularDependenciesAsync();
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result80 };
                case DetectorId.circular_type_references:
                    var result81 = await _analysisEngine.FindCircularTypeReferencesAsync(projectName);
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result81 };
                case DetectorId.duplicate_blocks_in_hierarchy:
                    {
                        if (string.IsNullOrEmpty(scopeName))
                        {
                            return new SentinelCallToolResult<object>() { IsSuccess = false, SuccessDetails = "duplicate_blocks_in_hierarchy requires scopeName to be the root type name." };
                        }
                        var result82 = await _cloneDetectionEngine.FindDuplicateBlocksInHierarchyAsync(scopeName, null, 4);
                        return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result82 };
                    }
                case DetectorId.duplicate_methods:
                    var result83 = await _analysisEngine.FindDuplicateMethodsAsync(5, projectName);
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result83 };
                case DetectorId.interface_extraction_candidates:
                    ...
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result84 };
                ...
                case DetectorId.long_parameter_list:
                    ...
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result90 };
                case DetectorId.namespace_path_mismatches:
                    {
                        ...
                        return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result91 };
                    }
                case DetectorId.primitive_obsession:
                    ...
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result92 };
                case DetectorId.structural_smells:
                    ...
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result93 };
                case DetectorId.type_cohesion:
                    var result94 = await _metricsEngine.AnalyzeTypeCohesionAsync(RequireFile(scope, scopeName), null);
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = result94 };

                default:
                    return new SentinelCallToolResult<object>() { IsSuccess = false, SuccessDetails = $"Unknown detector '{detector}'. Call describe_scan_detectors() for the full list." };
            }
        }
        catch (ArgumentException aex)
        {
            return new SentinelCallToolResult<object>() { IsSuccess = false, ErrorDetails = new ResultError(ToolErrorCode.InvalidArgument, aex.Message) };
        }
        catch (Exception ex)
        {
            _logger.LogError(ex, "Scan ({Detector}) failed", detector);
            return new SentinelCallToolResult<object>() { IsSuccess = false, ErrorDetails = ToolErrorMapper.ToResultError(ex, _workspaceManager, $"Scan ({detector})") };
        }
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            if (!string.IsNullOrEmpty(detector))
            {
                ...
                {
                    return Task.FromResult(new SentinelCallToolResult<object>() { IsSuccess = false, SuccessDetails = $"Unknown detector '{detector}'." });
                }
                entries = entries.Where(e => e.Id == detectorEnum);
            }

            return Task.FromResult(new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = entries.ToList() });
        }
        catch (Exception ex)
        {
            _logger.LogError(ex, "DescribeScanDetectors failed");
            return Task.FromResult(new SentinelCallToolResult<object>() { IsSuccess = false, ErrorDetails = ToolErrorMapper.ToResultError(ex, _workspaceManager, "DescribeScanDetectors") });
        }
    }
        ...
        try
        {
            switch (aspect)
            {
                case "controlFlow":
                    ...
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = resultControlFlow };
                case "dataFlow":
                    var resultDataFlow = await _refactoringEngine.AnalyzeDataFlowAsync(filePath, methodName, null, null, null, cancellationToken);
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = resultDataFlow };
                case "pathCoverage":
                    var resultPathCoverage = await _controlFlowEngine.AnalyzePathCoverageAsync(filePath, methodName, cancellationToken);
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = resultPathCoverage };
                case "unreachableCode":
                    ...
                    return new SentinelCallToolResult<object>() { IsSuccess = true, SuccessDetails = resultUnreachableCode };
                default:
                    return new SentinelCallToolResult<object>() { IsSuccess = false, SuccessDetails = $"Unknown aspect '{aspect}'. Valid values: controlFlow, dataFlow, pathCoverage, unreachableCode." };
            }
        }
        catch (Exception ex)
        {
            _logger.LogError(ex, "AnalyzeMethod ({Aspect}) failed for '{MethodName}' in '{FilePathWrapper}'", aspect, methodName, filePath);
            return new SentinelCallToolResult<object>() { IsSuccess = false, ErrorDetails = ToolErrorMapper.ToResultError(ex, _workspaceManager, "AnalyzeMethod") };
        }
    }
       ...
       CancellationToken cancellationToken = default)
    {
        ...
        catch (Exception ex)
        {
            ...
            {
                IsSuccess = false,
                ErrorDetails = ToolErrorMapper.ToResultError(ex, _workspaceManager, "ScanBreakingChanges")
            };
        }
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        catch (Exception ex)
        {
            ...
            {
                IsSuccess = false,
                ErrorDetails = ToolErrorMapper.ToResultError(ex, _workspaceManager, "ScanDuplicateBlocksInClass")
            };
        }
    }
        ...
        CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            else
            {
                if (string.IsNullOrEmpty(projectName))
                {
                    ...
                    {
                        IsSuccess = false,
                        ErrorDetails = new ResultError(ToolErrorCode.InvalidArgument, "projectName is required when persistBaseline=false.")
                    };
                    return toolResult;
                }
        ...
        catch (Exception ex) when (ex is ArgumentException && ex.Message.Contains("not found in solution"))
        {
            ...
            {
                IsSuccess = false,
                ErrorDetails = new ResultError(ToolErrorCode.Exception, $"GetPublicApiSurface failed: Project '{projectName}' not found in solution.")
            };
        }
        catch (Exception ex)
        {
            ...
            {
                IsSuccess = false,
                ErrorDetails = ToolErrorMapper.ToResultError(ex, _workspaceManager, "GetPublicApiSurface")
            };
        }
    }
