...
{
    // All modes available in the Advanced variant, derived from ToolClassRegistry's own map so
    // "--mode=all" can never drift from what AdvancedModeToToolClasses actually registers (it
