...
/// <summary>
/// No solution is loaded (<see cref="PersistentWorkspaceManager.CurrentSolution"/> is null) where
...
public static class ToolErrorMapper
{
    ...
    /// <see cref="SolutionNotLoadedException"/>, checking <see cref="PersistentWorkspaceManager.CurrentSolution"/>
