# Step 1.2 — Phase 1 test updates and new tests

**This step implements only this file** (see "File this step touches" below). Do not read, open,
or act on any other plan step file (e.g. via `ProjectDoc`) — another process runs each step as
its own isolated task.
