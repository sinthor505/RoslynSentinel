# Step 2.4 — Eval prompt/fixture updates + Phase 2 tests

## Prior state

Steps 2.1-2.3 already landed: the `TriviaEditIntent`-based fix, the shared `EolUtilities`, and the
...
2. Same for `AddModifierAsync`/`RemoveModifierAsync` if step 2.1's investigation showed they're
   independently affected by the same bug.
...
Once this gate passes, Phase 2 is complete. Proceed to
[09-phase3-directivekind.md](09-phase3-directivekind.md).
