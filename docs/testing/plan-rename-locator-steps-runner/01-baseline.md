...
# committing if this step changed any file.
readOnly: true
---
# Step 0 — Baseline
...
any code changes in this step. This is step 0 in the sequence; step 1 is
`02-locator-encode-decode.md`, but you do not need to open it.
